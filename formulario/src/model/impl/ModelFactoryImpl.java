...
public class ModelFactoryImpl extends EFactoryImpl implements ModelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ModelPackage.TRATA_ERRO: return createTrataErro();
			case ModelPackage.USUÁRIO: return createUsuário();
			default:
	 ...
	 * @generated
	 */
	public TrataErro createTrataErro() {
		TrataErroImpl trataErro = new TrataErroImpl();
		return trataErro;
	}
