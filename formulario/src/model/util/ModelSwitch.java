...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelPackage.TRATA_ERRO: {
				TrataErro trataErro = (TrataErro)theEObject;
				T result = caseTrataErro(trataErro);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.USUÁRIO: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Trata Erro</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Trata Erro</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTrataErro(TrataErro object) {
		return null;
	}
